...
<c:set var="hasAccountAuthority" value="${requestScope.hasAccountAuthority}" />
                ...
                <div class="col-sm-10">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" disabled
                               <c:if test="${hasSalesAuthority}">checked</c:if> />
                        <label class="form-check-label">売上登録</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" disabled
                               <c:if test="${hasAccountAuthority}">checked</c:if> />
